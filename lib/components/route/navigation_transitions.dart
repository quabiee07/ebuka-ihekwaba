...
class SlideRouteTransition extends PageRouteBuilder {
  ...
  SlideRouteTransition({
    ...
    super.settings,
            ...
            transitionDuration:
                position == SlidePosition.top ? Duration(milliseconds: 500) : Duration(milliseconds: 200),
            reverseTransitionDuration: position == SlidePosition.top ? Duration(milliseconds: 500) : Duration(milliseconds: 200),
